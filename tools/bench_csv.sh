...
gcc -std=gnu2x -Wall -Wextra -Wpedantic -Wno-unused-parameter -march=native \
    ...
    src/bitboard_tables.c tools/bench_backends.c -lncursesw
...
if [ ! -f "$CSV" ]; then
    echo "label,timestamp,array_ns,dyn_ns,tbl_ns,cpt_dyn_ns,cpt_tbl_ns,array_mops,dyn_mops,tbl_mops,cpt_dyn_mops,cpt_tbl_mops" > "$CSV"
fi
...
echo "${LABEL},${TS},${arr_ns},${dyn_ns},${tbl_ns},${cdy_ns},${ctb_ns},${arr_mops},${dyn_mops},${tbl_mops},${cdy_mops},${ctb_mops}" >> "$CSV"
